...
- (void)viewDidLoad {
    ...
    [_wallpaperImageView setImageURL:[NSURL URLWithString:IsX?_model.cover_hd_812h:_model.cover_hd_568h]];
    ...
    if (!_bottomView) {
        ...
        _bottomView.btmClickBlock = ^(NSInteger tag) {
            if (tag == 1) {
                ...
                NSURL *url = [NSURL URLWithString:@"https://github.com/dyshero/TimeBook"];
